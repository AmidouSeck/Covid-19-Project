...
for pdf_path in entries:
    try:
        ...
        regions = ['Dakar', 'Thiés', 'Diourbel', 'Fatick', 'Kaolack', 'Kaffrine', 'Touba', 'Kolda', 'Tamba',
                   'Ziguinchor', 'Saint-Louis', 'Matam', 'Sédhiou']
        regions_dict = {}
...
messagebox.showinfo('ACQUISITION ENDED SUCCESSFULLY')
